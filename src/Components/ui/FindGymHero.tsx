export default function FindGymHero() {
    return (
        <div className="bg-gradient-to-r from-orange-400 to-orange-500 rounded-2xl p-6 lg:p-8 text-white relative overflow-hidden">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
              <div className="flex-1 mb-4 lg:mb-0">
                <h1 className="text-2xl lg:text-4xl font-bold mb-3">Find Nearby Gyms</h1>
                <p className="text-orange-100 max-w-md text-sm lg:text-base">
                  Discover the perfect fitness center near you. Compare ratings, prices, and amenities to find your ideal workout spot.
                </p>
              </div>
